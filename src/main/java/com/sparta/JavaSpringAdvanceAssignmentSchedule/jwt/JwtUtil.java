package com.sparta.JavaSpringAdvanceAssignmentSchedule.jwt;
...
public class JwtUtil {
    ...
    public void checkAuth(String tokenValue){
        // JWT 토큰 substring
        ...
        if(authority.equals("USER")) throw new IllegalArgumentException("권한이 없습니다.");
    }
}
